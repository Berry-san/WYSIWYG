...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div className="relative scrollbar ">
      ...
      <aside
        ref={sidebar}
        className={`absolute left-0 top-0 z-40 scrollbar-none flex h-screen w-64 xl:w-80 flex-col overflow-y-hidden bg-darkerBlue duration-300 ease-linear  lg:static lg:translate-x-0 ${
          sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        {/* SIDEBAR HEADER */}
        <div className="flex items-center justify-between gap-2 py-5 lg:py-6 bg-darkBlue">
          <NavLink to="./">
            <div className="flex w-full gap-2 items-center justify-center px-4 lg:px-8">
              {/* <img src={logo} alt="logo" /> */}
              <span className="font-bold text-white">NEXTRO ABLE</span>
            </div>
          </NavLink>
        ...
        <div className="flex flex-col flex-1 overflow-y-auto duration-300 ease-linear bg-darkBlue">
          {/* Sidebar Menu */}
          <nav className="px-4 py-6 lg:pb-10 lg:px-8">
            {/* Menu Group */}
            <div>
